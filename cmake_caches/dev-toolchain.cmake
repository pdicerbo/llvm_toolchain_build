...
message( STATUS "EXECUTING CMAKE DEV TOOLCHAIN STAGE" )
...
foreach(target x86_64-unknown-linux-gnu)
  ...
  set(RUNTIMES_${target}_LIBCXX_ENABLE_ASSERTIONS ON CACHE BOOL "" )
...
set( LIBCXX_ENABLE_ASSERTIONS ON CACHE BOOL "" )                        # enable assertions inside the compiled library, and make it the default when compiling user code
